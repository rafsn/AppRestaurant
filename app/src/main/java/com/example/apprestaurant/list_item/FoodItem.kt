package com.example.apprestaurant.list_item
...
fun FoodItem(
    ...
    ConstraintLayout(
        ...
        val (imgFood, txtFoodName, txtFoodDescription, txtPrice, btAddCart, containerImg, rowItem) = createRefs()
        ...
        ), shape = ShapeDefaults.Small, elevation = CardDefaults.cardElevation(
